...
import { Feed, saveFeedBacksAsync } from "../../redux/filteredFeedbacks";
...
const Feedback = () => {
  ...
  const { feedbacks } = useAppSelector((state) => state.filteredFeedbacks);
  ...
  const gettingFeeds = () => {
    dispatch(saveFeedBacksAsync(feed));
